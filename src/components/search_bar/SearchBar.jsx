          ...
          <div className="relative">
            ...
            <Combobox.Input
              className={`w-full py-3 px-12 rounded-full text-bg_light border hover:bg-bg_input hover:border-bg_input ${
                isOpen ? "bg-bg_input border border-bg_input" : "bg-bg_dark border border-border"
              }`}
            ...
            />
            <Combobox.Button className={`${!searchValue ? "hidden" : ""}`}>
              <IoClose
                className={`absolute top-1/2 right-5 -translate-y-1/2 text-border text-2xl cursor-pointer `}
